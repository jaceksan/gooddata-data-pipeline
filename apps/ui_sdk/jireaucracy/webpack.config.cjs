...
const WORKSPACE_ID_CICD = pack.gooddata.workspaceIdCICD;
const WORKSPACE_ID_FAA = pack.gooddata.workspaceIdFAA;
    ...
    return [
        {
            ...
            plugins: [
                ...
                new DefinePlugin({
                    WORKSPACE_ID_CICD: JSON.stringify(WORKSPACE_ID_CICD),
                    WORKSPACE_ID_FAA: JSON.stringify(WORKSPACE_ID_FAA),
                }),
